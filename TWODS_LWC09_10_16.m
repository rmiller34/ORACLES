...
ncid=netcdf.open('16_09_10_07_14_00.2DS_H.conc.1Hz.nc');
...
altitude=netcdf.getVar(b,19)-75; % WGS84 Altitude
...
twodsLWC8 = twods_lwc(sawtooth_8_twods);
altitude8 =altitude_twods(sawtooth_8_twods);
timesaw8 =timevec_twods(sawtooth_8_twods);
...
title ('Twods LWC Sawtooth 3 09/10/2016')
datetick('x','HH:MM:SS');
