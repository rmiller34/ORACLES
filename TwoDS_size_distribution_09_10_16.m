...
eval(sprintf('Nsum%d=nanmean(TwoDS_Nd(sawtooth_%d_cas,:));',k,k));
...
%-----Plot Cosmetics-----%
eval(sprintf('title(''2DS Cloud droplet Size Distribution - Sawtooth Average - %10s'');',k,datestr(timevec_cas(1),2)));
