...
ncid=netcdf.open('16_09_20_06_33_39.2DS_H.conc.1Hz.nc');
b=netcdf.open('16_09_20_06_33_39.oracles.nc');
...
sawtooth_1_twods=7860+(new_twods_start-1):7990+(new_twods_start-1);
sawtooth_2_twods=8420+(new_twods_start-1):8510+(new_twods_start-1);
sawtooth_3_twods=11070+(new_twods_start-1):11170+(new_twods_start-1);
sawtooth_4_twods=12561+(new_twods_start-1):12657+(new_twods_start-1);
sawtooth_5_twods=18800+(new_twods_start-1):19210+(new_twods_start-1);
sawtooth_6_twods=23000+(new_twods_start-1):23060+(new_twods_start-1);
sawtooth_7_twods=23820+(new_twods_start-1):23870+(new_twods_start-1);
...
twodsLWC5 = twods_lwc(sawtooth_5_twods);
altitude5 =altitude_twods(sawtooth_5_twods);
timesaw5=timevec_twods(sawtooth_5_twods);
twodsLWC6 = twods_lwc(sawtooth_6_twods);
altitude6 =altitude_twods(sawtooth_6_twods);
timesaw6=timevec_twods(sawtooth_6_twods);
twodsLWC7 = twods_lwc(sawtooth_7_twods);
altitude7 =altitude_twods(sawtooth_7_twods);
timesaw7 =timevec_twods(sawtooth_7_twods);
...
title ('Twods LWC Sawtooth 7 09/20/2016')
datetick('x','HH:MM:SS');
